...
public class Test {
    ...
    public static void main(String[] args) {
        try {
            Book book = new Book("红楼梦", 100, "transient字段","static字段");
            File file = new File("d:\\serializable.txt");
            System.out.println(JSON.toJSONString(book));
            System.out.println(book.getTransientField());
            System.out.println(Book.getStaticField());
...
//            System.out.println(book1.getTransientField());
            System.out.println(Book.getStaticField());
        }catch (Exception e){
            e.printStackTrace();
        }
